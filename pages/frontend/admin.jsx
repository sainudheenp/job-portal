                ...
                <div class="container mx-auto mt-12">
                    <div class="grid gap-4 lg:grid-cols-3">
                        <div class="flex items-center px-4 py-6 bg-black rounded-md shadow-md">
                            ...
                            <div class="mx-4">
                                <h4 class="text-2xl font-semibold text-white">100</h4>
                                ...
                                <table class="min-w-full">
                                    <thead>
                                        <tr className='bg-black'>
                                            <th
                                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-white uppercase border-b border-gray-200 ">
                                                Name</th>
                                            <th
                                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-white uppercase border-b border-gray-200 ">
                                                Email</th>
